...
if("TRUE" STREQUAL "TRUE")
  set(mesh_map_SOURCE_PREFIX /home/mrsl_student/git/catkin_ws/src/mesh_map-master)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mesh_map' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrsl_student/git/catkin_ws/src/mesh_map-master/${idir}'.  Ask the maintainer 'Giuseppe <Giuseppe@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mrsl_student/git/catkin_ws/devel/lib;/home/mrsl_student/git/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
set(depends "roscpp;sensor_msgs;image_transport;cv_bridge;tf")
